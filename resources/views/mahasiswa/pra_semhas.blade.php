                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p> Jadwal seminar hasil akan ditentukan oleh Program Studi. Silahkan periksa jadwal seminar
                                proposal
                            ...
                            @if ($mhs->no_statusAkses > 3)
                                <div class="d-grid gap-2 d-md-flex justify-content">
                                    ...
                                    <a href="{{ '/mahasiswa/jadwal_semhas' }}" target="blank"
                                        class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Jadwal</a>
                                </div>
                            @else
                                <div class="d-grid gap-2 d-md-flex justify-content">
                                    <!-- preview akan membawa mahasiswa ke halaman form yang ingin diunduh -->
                                    <a href="#" class="btn btn-primary btn-sm disabled"><i class="bi bi-eye"></i>
                                        Lihat Jadwal</button></a>
                                </div>
                            @endif
                        </div>
                    </div>
