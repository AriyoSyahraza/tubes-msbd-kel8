                ...
                <div class="col-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="calon_pembimbing.blade.php">
                                ...
                                <select name="bidang_ilmu1" id="bidang_ilmu1" class="form-select">
                                    ...
                                    <option value="1">Bidang Ilmu 1</option>
                                    <option value="2">Bidang Ilmu 2</option>
                                    <option value="3">Bidang Ilmu 3</option>
                                    <option value="4">Bidang Ilmu 4</option>
                                    <option value="5">Bidang Ilmu 5</option>
                                </select>
                                <br>
                                <label for="bidang_ilmu1">Bidang Ilmu 2</label>
                                <select name="bidang_ilmu1" id="bidang_ilmu1" class="form-select">
                                    <option value="0">Pilih bidang ilmu</option>
                                    <option value="1">Bidang Ilmu 1</option>
                                    <option value="2">Bidang Ilmu 2</option>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content">
                                <a href="/mahasiswa/calon_pembimbing/{{ Auth::user()->id }}" target="blank"
                                    class="btn btn-primary btn-sm"><i class="bi bi-printer-fill"></i> Cetak </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @if ($mhs->no_statusAkses > 1)
                                <div class="d-grid gap-2 d-md-flex justify-content">
                                    ...
                                    <a href="{{ '/mahasiswa/jadwal_sempro' }}"><button class="btn btn-success btn-sm"><i
                                                class="bi bi-eye"></i> Lihat Jadwal</button></a>
                                </div>
                            @else
                                <div class="d-grid gap-2 d-md-flex justify-content">
                                    <!-- preview akan membawa mahasiswa ke halaman form yang ingin diunduh -->
